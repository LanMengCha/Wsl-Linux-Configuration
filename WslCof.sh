...
echo "安装必备软件..."
sudo apt install -y docker && sudo apt install -y chromium && sudo apt install -y g++ && sudo apt install -y python && sudo apt install -y wget && sudo apt install -y git && sudo apt install -y curl && sudo apt install -y vim && sudo apt install -y neofetch
neofetch
echo "安装Z Shell..."
